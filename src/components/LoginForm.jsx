      ...
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[18px] text-[#40434a] leading-normal">
            Login to explore, customize, and shop unique creator-made<br />
            products.
          </p>
        </div>
          ...
          <CardContent className="space-y-6 p-0">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-[18px] font-medium text-[#3f4247]">
                  Email
                </Label>
              ...
              {/* Password Field */}
              <div className="space-y-2">
                <Label htmlFor="password" className="text-[18px] font-normal text-[#393b47]">
                  Password
                </Label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-white px-4 text-[15px] text-[#33383e]">or</span>
              </div>
            </div>
        ...
        <div className="text-center mt-8">
          <p className="text-[20px] font-medium text-[#4d4d55]">
            ...
            <button className="text-[#783ae8] hover:underline">
              Signup
            </button>
          </p>
        </div>
